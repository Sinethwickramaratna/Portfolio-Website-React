...
function HeroSection() {
  ...
  return (
    <>
      {/* Loading overlay — sits on TOP of content, not instead of it */}
      {!isLoaded && <LoadingPage />}

      {/* Hero is ALWAYS in the DOM so the browser can paint the h1 immediately */}
      <div
      ...
      >
        ...
        <div className="hero-container">
          ...
          <div className="hero-content">
            {/* h1 is always rendered — no conditional, no delay */}
            <h1 className="hero-title loaded">
